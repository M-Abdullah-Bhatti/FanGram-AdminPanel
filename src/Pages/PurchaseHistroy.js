...
const headCells = [
	...
	{ id: "Category", alignment: "left", label: "Price" },
	{ id: "Price", alignment: "left", label: "Wallet Address" },
	{ id: "Date", alignment: "left", label: "Date" },
	{ id: "Status", alignment: "left", label: "Status" },
	{ id: "e-tag-id", alignment: "left", label: "E-Tag ID" },
];
										...
										?.map((row, index) => {
											...
											return (
												<TableRow
													...
													onClick={() => {
														history.push({
															pathname: `/dashboard/editOrder/${row._id}`,
														});
													}}>
													...
													<TableCell align='left'>
														<Typography
															style={{
																backgroundColor: row.OrderCompleted
																	? "#E6FDED"
																	: "#FDF4E2",
																borderRadius: "20px",
																textAlign: "center",
																padding: "5px 8px",
																color: row.OrderCompleted
																	? "#36AC65"
																	: "#F0A512",
																fontSize: "14px",
																fontWeight: "500",
															}}>
															{row?.OrderCompleted ? "Completed" : "Incomplete"}
														</Typography>
													</TableCell>
													<TableCell align='left'>
														<Typography
															style={{ fontWeight: "600", fontSize: "16px" }}>
															{row?.Products[0]?.EtagId}
														</Typography>
													</TableCell>
												</TableRow>
											);
